...
const styles = {
  wrapper: "h-screen min-w-[10rem] max-w-[30rem] fkex.[1.2] p-[2rem]",
  accentedButton: `flex items-center justify-center text-sm bg-black text-white
   my-[2rem] py-[.6rem]  rounded-full`,
  searchBar:
    ...
    <div className={styles.wrapper}>
      ...
      <div className={styles.recommendationContainer}>
        ...
        {recommendedPosts.map(post => (
          ...
          <Image className={styles.recommendationThumbnail} src={post.image} width={100} height={100} /></div>
        </div>
           ))}
      </div>
...
const recommendedPosts = [
  ...
  {
    title: 'ultimate js course developers begginners',
    image: TutorialImg,
    author: {
      name: 'rameh qazi',
      image: Qazi,
